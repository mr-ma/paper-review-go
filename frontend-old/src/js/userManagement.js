...
function validateEmail(email) {
  ...
  function loadNavbar ( user, resolve, reject ) {
    ...
    if (user.admin == 1) var navbarPath = '/usermanagement/navbarAdmin.html';
    else var navbarPath = '/usermanagement/navbar.html';
  ...
  function loadModals ( user, resolve, reject ) {
    $.get('/usermanagement/modals.html', function (data ) {
